...
qemu-system-x86_64 -machine q35 -smp 2 -no-reboot -s  -D qemu.log -d int -m 1024M -serial stdio -bios ./ovmf-x64/OVMF_CODE-pure-efi.fd  -drive file=kernel.iso,index=1,media=cdrom -drive file=ovmf-x64/UefiShell.iso,index=2,media=cdrom
